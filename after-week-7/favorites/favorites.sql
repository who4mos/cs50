...
WHERE title LIKE '%brooklyn 99%' OR title LIKE '%b99%';
...
UPDATE shows
SET title = 'Friends'
WHERE title LIKE '%game of thrones%' OR title LIKE '%got%';
...
WHERE title LIKE '%parks and rec%';
...
WHERE title LIKE '%queen%s gambit%';
